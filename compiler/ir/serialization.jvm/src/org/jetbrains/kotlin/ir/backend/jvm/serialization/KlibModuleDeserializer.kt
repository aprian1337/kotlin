...
) : FileDeserializationState(linker, file, fileReader, fileProto, deserializeBodies, allowErrorNodes, deserializeInlineFunctions, moduleDeserializer, useGlobalSignatures = false, handleNoModuleDeserializerFound) {
