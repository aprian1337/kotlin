...
val testDataPathList = listOf(
    kotlinBuildProperties.pathToKotlinModularizedTestData to "Kotlin",
    kotlinBuildProperties.pathToIntellijModularizedTestData to "IntelliJ",
    kotlinBuildProperties.pathToYoutrackModularizedTestData to "YouTrack"
